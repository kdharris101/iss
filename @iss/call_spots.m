...
SpotColors = bsxfun(@rdivide, o.SpotColors, prctile(o.SpotColors, o.SpotNorm(1), o.SpotNorm(2)));
...
for r =1:o.nRounds
    m = squeeze(SpotColors(o.SpotIsolated,:,r)); % data: nCodes by nBases
...
o.SpotCode = CharCode(BestCode);
o.SpotGene = GeneName(BestCode);
