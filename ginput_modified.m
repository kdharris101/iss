function [out1,out2,out3] = ginput_modified(arg1,CrossHairColor)
...
%   Modified so the crosshair color does not have to be black
...
if ~matlab.ui.internal.isFigureShowEnabled
    ...
    initialState = setupFcn(fig,CrossHairColor);
...
function initialState = setupFcn(fig,CrossHairColor)
...
initialState.CrossHair = createCrossHair(fig,CrossHairColor);
