...
The right plot tells you a bit more of what is happening behind the curtain. It shows you the underlying probability distributions that get you to the final probability. The probability that we are trying to maximise is the probability that the spot, <img src="//i.upmath.me/svg/s" alt="s" /> can be explained by the gene <img src="https://tex.s2cms.ru/svg/ax%5E2%2Bbx%2Bc%3D0" alt="g" />, <img src="https://tex.s2cms.ru/svg/ax%5E2%2Bbx%2Bc%3D0" alt="P(s\mid g)". />
